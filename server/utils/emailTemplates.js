export function genereateVerificationOtpEmailTemplate(otpCode) {
...
export function genereateForgotPasswordEmailTemplate(resetPasswordUrl) {
  return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
...
export function genereateBookReturnReminderEmailTemplate(name, dueDate) {
  return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
    <h2 style="color: #fff; text-align: center;">Library Book Return Reminder</h2>
    <p style="font-size: 16px; color: #ccc;">Hello ${name},</p>
    <p style="font-size: 16px; color: #ccc;">This is a reminder that you have not returned the book you borrowed from our library. Please return the book as soon as possible to avoid any fines.</p>
    <div style="text-align: center; margin: 20px 0;">
        <span style="display: inline-block; font-size: 18px; font-weight: bold; color: #000; padding: 10px 20px; border: 1px solid #fff; border-radius: 5px; background-color: #fff;">
            Due Date: ${dueDate}
        </span>
    </div>
    <p style="font-size: 16px; color: #ccc;">If you have already returned the book, kindly ignore this message.</p>
    <p style="font-size: 16px; color: #ccc;">For any assistance, feel free to contact us.</p>
    <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
        <p>Thank you,<br>BookWorm Team</p>
        <p style="font-size: 12px; color: #444;">This is an automated message. Please do not reply to this email.</p>
    </footer>
